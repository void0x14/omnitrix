...
pub use stack::{
    ...
    import_from_stack, preview_export, preview_import, resolve_stack_path, FormatKind,
    MergePolicy, PreviewEntry, StackCapability, StackDef, StackPresence, SyncDirection,
    SyncPreview, SyncSummary,
};
pub use store::{
